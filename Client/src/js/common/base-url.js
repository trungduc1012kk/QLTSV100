...
export const BASE_URL_Budget = "https://localhost:44335/api/v1/Budgets";
export const BASE_URL_Increment_Property =
  "https://localhost:44335/api/v1/IncrementProperties";
